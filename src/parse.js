 ...
 * 
 * @returns {KtOtfCoverageTableImpl }
 * 
 */
Parser.prototype.parseCoverage = /** @return {KtOtfCoverageTableImpl } */ function() {
    ...
    if (format === 1) {
        ...
        /** @type {Array<(Extract<KtOtfCoverageTableImpl, { format: 2, } >)["ranges"][number] > } */
 ...
 * 
 */
Parser.prototype.parseClassDef = /** @return {KtOtfClassDefTableImpl } */ function() {
    const startOffset = this.offset + this.relativeOffset;
    const format = this.parseUShort();
    if (format === 1) {
        return {
