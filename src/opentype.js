...
function parseBuffer(buffer, opt={}) {
    ...
    const nameTable = uncompressTable(data, nameTableEntry ?? athrow(`missing nameTableEntry`) );
    ...
    const hmtxTable = uncompressTable(data, hmtxTableEntry ?? athrow(`missing hmtxTableEntry`) );
